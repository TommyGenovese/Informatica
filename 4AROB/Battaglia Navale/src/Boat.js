//Ho usato la classe boat per creare le varie navi

class Boat {
	//grid è la griglia, size è la lunghezza della nave, direction è la direzione, width e height,
	//	 unkownInfo l'ho usato nel caso in cui non si abbiano infomrazioni
	...
	setInfoByCoords() {
		...
		throw 'Le coordinate non corrispondono a nessuna nave';
	}
	...
	//se la barca è affondata esegue questa funzione
	isSunken() {
