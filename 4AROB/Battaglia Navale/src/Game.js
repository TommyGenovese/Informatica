class Game {
	constructor() {
		...
		Game.gridSize = 10;
		Game.numBoatTypes = 5;
		Game.numBoatsPerType = [0, 1, 2, 1, 1, 1];
	...
	//Questo switch-case controlla cosa si ha colpito
	...
	//sceglie randomicamente chi inizia
	static whoStarts() {
	...
	//a seconda di chi preme (giocatore o computer) lo segna
	...
	//setta le griglie dei due giocatori
